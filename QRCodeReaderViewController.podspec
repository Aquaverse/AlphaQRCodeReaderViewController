Pod::Spec.new do |s|
  ...
  s.homepage              = 'https://github.com/YannickL/AlphaQRCodeReaderViewController'
  s.authors               = { 'Yannick Loriot' => 'contact@yannickloriot.com' }
  s.social_media_url      = "https://twitter.com/yannickloriot"
  s.source                = { :git => 'https://github.com/yannickl/AlphaQRCodeReaderViewController.git',
                              :tag => s.version.to_s }
  s.requires_arc          = true
  s.source_files          = ['AlphaQRCodeReaderViewController/*.{h,m}']
